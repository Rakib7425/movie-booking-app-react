    ...
    <>
      <header className='flex justify-between items-center my-4'>
        <div className="logo flex" >
          ...
          <h1 className='text-xl ml-4 text-green-400 '> <NavLink to={authUser && '/user-profile'} style={navLinksStyles} > {authUser ? `Hello-  ${authUser.Name} ` : <span className='text-red-500' style={{ textDecoration: 'none' }}>Login to Access</span>}</NavLink> </h1>

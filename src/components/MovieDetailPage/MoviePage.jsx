  ...
  return (
    <div className={styles.container}>
      <div className={`${styles.main} sm:flex-col md:flex-col xl:flex-row`}>
        <img className={!movie?.backdrop_path ? 'w-80 h-80 my-auto' : ''} src={!movie?.backdrop_path ? 'https://w7.pngwing.com/pngs/116/765/png-transparent-clapperboard-computer-icons-film-movie-poster-angle-text-logo-thumbnail.png' : `${imagePrefixUrl}${movie?.backdrop_path}`} alt="aMovieImg" />
